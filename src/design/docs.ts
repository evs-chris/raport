...
<p>The latter is a bit longer, but tends to be easier to follow the value through the flow, especially when the intermediate steps get longer or more complicated.</p>
</div>
